...
**v1 built; 56-case machine regression green（`python3 tests/test_codex_machines.py` 可复跑）; Stop-hook 接通与真实小白field test 待首跑验证（步骤已写进剧本）。** Codex alpha 通道日更，装机后请跑 selftest 以你的版本为准。Treat as beta.
